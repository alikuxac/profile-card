/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 2d3d09af7e0340523cf8c1574cd79bf6)
// Runtime types generated with workerd@1.20260915.1 2026-03-05 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	profile_card_db: D1Database;
	NEXTJS_ENV: string;
	ADMIN_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "ADMIN_SECRET">> {}
}
